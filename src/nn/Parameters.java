...
public class Parameters implements Serializable{
	...
	/**
	  ...
	  */
	  ...
	  // If true, the gradients will propagate to the embedding matrix.
	  public boolean bEmbeddingFineTune = true;
	  ...
	  private void setProperties(Properties props) {
		...
		bEmbeddingFineTune = PropertiesUtils.getBool(props, "bEmbeddingFineTune", bEmbeddingFineTune);
	  ...
	  public void printParameters() {
		...
		System.out.printf("bEmbeddingFineTune = %b%n", bEmbeddingFineTune);
